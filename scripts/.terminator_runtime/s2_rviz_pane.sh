...
echo "map : $MAP_FILE"
echo "log : /home/tankcc/tankcc/logs/scenario2_terminator_20260709_092942/rviz_scenario2.log"
echo
...
sleep 0.7
ros2 launch rviz_visualization tank_scenario2_map_view.launch.py 2>&1 | tee "/home/tankcc/tankcc/logs/scenario2_terminator_20260709_092942/rviz_scenario2.log"
echo
